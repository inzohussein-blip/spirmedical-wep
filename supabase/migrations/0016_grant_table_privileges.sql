...
--
-- ⚠️ تصحيحٌ لاحق (0041): قولُ الترويسة أعلاه إنّ `service_role` «يتجاوز
-- البوّابتين» خطأ. يتجاوز RLS وحدها، أمّا `GRANT` فلا. فبقي هو أيضاً بلا
-- منحة، وكلُّ ما يمرّ بـ`createAdminClient()` كان يُردّ 42501 — حتى
-- **قراءةُ** `users`. يُمنح في 0041.
--
