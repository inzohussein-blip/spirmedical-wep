              ...
              <div className="summary-card">
                ...
                <div className="summary-rows">
                  <div className="summary-row">
                    <span className="summary-label">📅 التاريخ والوقت</span>
                  ...
                  {data.service?.needsAddress && (
                    <div className="summary-row">
                      <span className="summary-label">📍 العنوان</span>
                      <span className="summary-value">{data.address}</span>
                    </div>
                  )}

                  <div className="summary-row">
                    <span className="summary-label">⏱ المدة المتوقعة</span>
                    <span className="summary-value">{formatDuration(data.service?.duration || 60)}</span>
                  </div>

                  {data.notes && (
                    <div className="summary-row">
                      <span className="summary-label">📝 ملاحظات</span>
