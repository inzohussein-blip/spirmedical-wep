      ...
      <div className="actions-grid">
        {canCall && (
          <button onClick={handleCall} className="action-btn primary">
            <span className="action-icon"><Phone size={18} strokeWidth={2.2} /></span>
        ...
        {canCall && (
          <button onClick={handleWhatsApp} className="action-btn whatsapp">
            <span className="action-icon"><MessageCircle size={18} strokeWidth={2.2} /></span>
            <span>واتساب</span>
          </button>
        )}
        ...
        {address && (
          <button onClick={handleOpenMaps} className="action-btn">
            <span className="action-icon"><MapPin size={18} strokeWidth={2.2} /></span>
        ...
        {canCancel && (
          <button onClick={() => setShowCancelModal(true)} className="action-btn danger">
            <span className="action-icon"><X size={18} strokeWidth={2.4} /></span>
        ...
        {canRebook && (
          <button onClick={handleRebook} className="action-btn primary">
            <span className="action-icon"><RefreshCw size={18} strokeWidth={2.2} /></span>
