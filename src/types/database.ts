...
export type Database = {
  public: {
    Tables: {
      // ✨ مسار سحب الدم/التحاليل — من migration 0003_health_records.sql
      partner_labs: {
        Row: {
          id: string;
          name_ar: string;
      ...
      lab_orders: {
        Row: {
          ...
          status: 'pending' | 'sample_collected' | 'sent_to_lab' | 'processing' | 'results_ready' | 'delivered' | 'cancelled';
          notes: string | null;
      ...
      // ✨ حجوزات الصيدلية — migration 0005
      pharmacy_reservations: {
        Row: {
          ...
          status: 'pending' | 'confirmed' | 'partially_available' | 'ready_for_pickup' | 'picked_up' | 'cancelled' | 'expired';
