 ...
 * ═══════════════════════════════════════════════════════════════
 *
 * ⚠️ **بيانات تطويرٍ لا بيانات إطلاق — لا تُدرَج في قاعدةٍ حيّة.**
 *
 * الأسماء والمواقع حقيقية (مستشفى الصدر التعليمي، النجف…) لكنّ **بيانات
 * الاتصال مُختلَقة**:
 *
 *   • الهواتف كانت كتلاً متسلسلة (07712340001 · 07712340002 …)، فقُنّعت
 *     إلى «0771 xxx xxxx» بقرار المالك (مع 0045 في الإنتاج).
 *   • و`phone_emergency: '912'` المُختلَق صار `122` — إسعافُ العراق الحكوميّ.
 *
 * واقتران اسمٍ حقيقيّ برقمٍ مُختلَق أسوأ من دليلٍ فارغ: مريضٌ في حالة طوارئ
 * يقرأ «مستشفى الصدر التعليمي» ويطلب رقماً لا يخصّه. والتطبيق فيه شاشة
 * طوارئ (`/guest/sos`) تعرض هذه الأرقام.
 *
 * فقبل الإدراج في الإنتاج تُستبدَل الهواتف وأرقام الطوارئ بأرقامٍ موثَّقة
 * من مصادرها. أمّا للتطوير والعرض التجريبيّ فالبيانات صالحة كما هي.
 *
 * (كانت ترويسة `hospitals.ts` تصف هذه البيانات بأنّها «حقيقية» — صحيحٌ في
 *  الأسماء والإحداثيات، غيرُ صحيحٍ في وسائل الاتصال.)
 * ═══════════════════════════════════════════════════════════════
 */
