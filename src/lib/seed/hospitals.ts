/**
 * ═══════════════════════════════════════════════════════════════
 * 🏥 Hospitals Seed Data — أسماءٌ وإحداثياتٌ حقيقية، **وهواتفُ مُختلَقة**
 *
 * ⚠️ الهواتف كتلٌ متسلسلة و`phone_emergency` واحدٌ للجميع. راجع التحذير
 * الكامل في `src/lib/seed/index.ts` قبل أيّ إدراجٍ في الإنتاج.
 * ═══════════════════════════════════════════════════════════════
 */
