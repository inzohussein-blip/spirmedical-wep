        ...
        {status === 'loading' && (
          <>
            <div className="mb-6 animate-spin">
              <svg className="w-12 h-12 mx-auto text-emerald-700" fill="none" viewBox="0 0 24 24">
          ...
          <>
            ...
            <div className="mt-6 space-y-3">
              <button
                ...
                className="w-full bg-emerald-700 text-white py-3 rounded-lg hover:bg-emerald-800 transition font-medium"
              >
                العودة للدخول
              </button>
              <button
                onClick={() => router.push('/register')}
                className="w-full border-2 border-emerald-700 text-emerald-700 py-3 rounded-lg hover:bg-emerald-50 transition font-medium"
              >
                إنشاء حساب جديد
              </button>
            </div>
