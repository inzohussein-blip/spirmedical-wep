...
export default async function AdminOrderDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      <Link href="/admin/orders" style={{ fontSize: 12, color: 'var(--ink-3)', textDecoration: 'none', marginBottom: 12, display: 'inline-block' }}>
        ← رجوع
      </Link>
          ...
          <div style={{ background: 'var(--white)', borderRadius: 14, padding: 20, marginBottom: 16 }}>
            ...
            {patient && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ flex: 1 }}>
                  <Link href={`/admin/patients/${patient.id}`} style={{ fontSize: 14, fontWeight: 700, color: 'var(--ink)', textDecoration: 'none' }}>
          ...
          <div style={{ background: 'var(--white)', borderRadius: 14, padding: 20 }}>
            ...
            {specialist ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ flex: 1 }}>
                  <Link href={`/admin/specialists/${specialist.id}`} style={{ fontSize: 14, fontWeight: 700, color: 'var(--ink)', textDecoration: 'none' }}>
