...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/admin44/seed-data', icon: '📦', label: 'البيانات الأولية', permission: 'admins.manage' },
  ...
  { href: '/admin44/doctors', icon: '🩺', label: 'أطباء العائلة', permission: 'specialists.view' },
  ...
  { href: '/admin44/analytics', icon: '📈', label: 'Analytics' },
  { href: '/admin44/coupons', icon: '🎁', label: 'الكوبونات', permission: 'coupons.manage' },
  // ─── V25.14: Beta Launch ───
  { href: '/admin44/launch-checklist', icon: '🚀', label: 'قائمة الإطلاق' },
  { href: '/admin44/beta-codes', icon: '🎟️', label: 'رموز Beta' },
  { href: '/admin44/feedback', icon: '💬', label: 'الملاحظات' },
  { href: '/admin44/bugs', icon: '🐛', label: 'الأعطال' },
  // ─── النظام ───
